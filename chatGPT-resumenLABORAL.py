...
CHAT_REFINE_PROMPT_TMPL_MSGS = [
    ...
    HumanMessagePromptTemplate.from_template(
        ...
        "Es obligatorio que la salida contenga como minimo 300 palabras.\n"        
...
# query = "Explica detalladamente qué hechos en conflicto del fallo para cada acusado. Si no tienes información habla de los hechos jurídicos generales del fallo"
...
query = "Hace un resumen extensivo sobre los temas importantes del fallo. Nombra y explica las normas o leyes citadas. El resumen debe contener como mínimo 300 palabras"
