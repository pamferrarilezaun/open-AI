...
# Divide los datos (en este caso el txt) en documentos mas pequeños
...
OPENAI_API_KEY = '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'
...
query = "¿A cuál clasificacion pertenece: derecho penal o derecho penal economico o derecho privado o derecho procesal o derecho procesal penal o derecho publico o derecho laboral? ¿Porque?"

# Busca documentos similares semanticamente en el texto en base a la pregunta realizada. 
docs = docsearch.similarity_search(query)

print(docs)

# A partir de aca se agrega langchain
# Primer parametro: En este caso se utiliza el modelo curie
...
respuesta_final = chain.run(input_documents=docs, question=query)
